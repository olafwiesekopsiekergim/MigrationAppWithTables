table 5001949 "Payment Registration Set"
{
    // ================================================================================
    ...
    Caption = 'Payment Registration Set';
    ...
    keys
    {
        key(Key1; "Payment No.", "Payment Order No.", "Vendor No.", "Trading Type", "Country Code", "Document Type", "Index No.", "Passaging Transit", "Capitel No. Goods", "Broken Transit", "Info Transit unsalable Inv", "Info Transit unsalable forei.", "Due Date Proceeds Transit YYMM")
        {
            Clustered = true;
        }
