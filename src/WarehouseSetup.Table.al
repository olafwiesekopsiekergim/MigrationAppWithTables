table 5769 "Warehouse Setup"
{
    ...
    //   New field 5012400 "Excess pick for consumption"
    ...
    fields
    {
        ...
        field(2; "Whse. Receipt Nos."; Code[10])
        {
            AccessByPermission = TableData "Warehouse Receipt Header" = R;
            Caption = 'Whse. Receipt Nos.';
            TableRelation = "No. Series";
        }
        field(3; "Whse. Put-away Nos."; Code[10])
        {
            AccessByPermission = TableData "Posted Invt. Put-away Header" = R;
            Caption = 'Whse. Put-away Nos.';
            TableRelation = "No. Series";
        }
        field(5; "Whse. Pick Nos."; Code[10])
        {
            AccessByPermission = TableData "Posted Invt. Pick Header" = R;
            Caption = 'Whse. Pick Nos.';
            TableRelation = "No. Series";
        }
        field(6; "Whse. Ship Nos."; Code[10])
        {
            AccessByPermission = TableData "Warehouse Shipment Header" = R;
            Caption = 'Whse. Ship Nos.';
            TableRelation = "No. Series";
        }
        field(7; "Registered Whse. Pick Nos."; Code[10])
        {
            AccessByPermission = TableData "Posted Invt. Pick Header" = R;
            Caption = 'Registered Whse. Pick Nos.';
            TableRelation = "No. Series";
        }
        field(10; "Registered Whse. Put-away Nos."; Code[10])
        {
            AccessByPermission = TableData "Posted Invt. Put-away Header" = R;
        ...
        field(7301; "Posted Whse. Receipt Nos."; Code[10])
        {
            AccessByPermission = TableData "Warehouse Receipt Header" = R;
            Caption = 'Posted Whse. Receipt Nos.';
            TableRelation = "No. Series";
        }
        field(7303; "Posted Whse. Shipment Nos."; Code[10])
        {
            AccessByPermission = TableData "Warehouse Shipment Header" = R;
            Caption = 'Posted Whse. Shipment Nos.';
            TableRelation = "No. Series";
        }
        field(7304; "Whse. Internal Put-away Nos."; Code[10])
        {
            AccessByPermission = TableData "Warehouse Source Filter" = R;
            Caption = 'Whse. Internal Put-away Nos.';
            TableRelation = "No. Series";
        }
        field(7306; "Whse. Internal Pick Nos."; Code[10])
        {
            AccessByPermission = TableData "Warehouse Source Filter" = R;
            Caption = 'Whse. Internal Pick Nos.';
            TableRelation = "No. Series";
        }
        field(7308; "Whse. Movement Nos."; Code[10])
        {
            AccessByPermission = TableData "Warehouse Source Filter" = R;
            Caption = 'Whse. Movement Nos.';
            TableRelation = "No. Series";
        }
        field(7309; "Registered Whse. Movement Nos."; Code[10])
        {
            AccessByPermission = TableData "Warehouse Source Filter" = R;
            Caption = 'Registered Whse. Movement Nos.';
            TableRelation = "No. Series";
        }
        field(5012400; "Excess Pick for Consumption"; Boolean)
        {
            Caption = 'Excess Pick for Consumption';
