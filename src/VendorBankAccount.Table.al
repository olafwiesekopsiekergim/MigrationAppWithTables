table 288 "Vendor Bank Account"
{
    ...
    // 
    // 
    // MC       17.12.2015  DT                  * Setup Check BankBranch/IBAN no with VIPPS Interface
    ...
    fields
    {
        ...
        field(14; "Bank Account No."; Text[34])
        {
        ...
        field(5157894; "Mandate ID"; Code[35])
        {
            Caption = 'Mandate Id';
            Description = 'PMT';
            TableRelation = "Bank Account Mandate" WHERE ("Account Type" = CONST (Vendor),
