table 5034613 "Recall Line"
{
    ...
    // 
    // #PMW16.00.02.01:T502 14.12.10 DEMSR.IST
    //   Wrong function call deleted
    // 
    ...
    fields
    {
        ...
        field(160; "Recall No."; Code[20])
        {
            Caption = 'Recall No.';
            TableRelation = "Recall Header";
        }
    ...
    keys
    {
        ...
        key(Key6; "Recall No.", "Source Type", "Source No.", "Item No.", "Variant Code", "Lot No.", "Serial No.")
        {
        }
    }
