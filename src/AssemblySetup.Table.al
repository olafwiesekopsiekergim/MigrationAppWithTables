table 905 "Assembly Setup"
{
    ...
    fields
    {
        ...
        field(10; "Assembly Order Nos."; Code[10])
        {
            AccessByPermission = TableData "Sales Shipment Header" = R;
            Caption = 'Assembly Order Nos.';
            TableRelation = "No. Series";
        }
        field(20; "Assembly Quote Nos."; Code[10])
        {
            Caption = 'Assembly Quote Nos.';
            TableRelation = "No. Series";
        }
        field(30; "Blanket Assembly Order Nos."; Code[10])
        {
            AccessByPermission = TableData "Sales Shipment Header" = R;
            Caption = 'Blanket Assembly Order Nos.';
            TableRelation = "No. Series";
        }
        field(50; "Posted Assembly Order Nos."; Code[10])
        {
