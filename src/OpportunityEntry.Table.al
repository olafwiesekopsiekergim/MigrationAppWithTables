table 5093 "Opportunity Entry"
{
    ...
    keys
    {
        ...
        key(Key8; Active, "Salesperson Code", "Estimated Close Date", "Action Taken", "Sales Cycle Code", "Sales Cycle Stage", "Completed %", "Probability %", "Contact No.", "Contact Company No.", "Campaign No.", "Chances of Success %", "Estimated Value (LCY)", "Calcd. Current Value (LCY)", "Close Opportunity Code")
        {
            MaintainSIFTIndex = false;
            SumIndexFields = "Estimated Value (LCY)", "Calcd. Current Value (LCY)";
        }
        key(Key9; "Close Opportunity Code")
        {
        }
    }
