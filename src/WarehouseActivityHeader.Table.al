...
{
    // P0001 24.02.16 DEBIE.ARE New fields 50040 "RM Gewicht (RMD)", 50041 "RM Gewicht (RMD)", 50042 "RM Paketnr. (RMD)",
    //   50043 "RM Zusteller (RMD)", 50044 "RM Lieferscheinnr. (RMD)", 50045 "RMD Status",
    //   50046 "RMD Rückinfo an Düperthal", 50047 "RMD Sammelsendung", 50048 "RMD Deb.-KD-Nr. bei Spedition"
    //   50049 "RMD-Packzettel Löschen erlaubt"
    //   New Key "RMD Status". New functions ChkChangeStatus, ZeilenOkBei_RMD_Freigabe. Code in OnDelete changed
    ...
    fields
    {
        ...
        field(63; "Registering No. Series"; Code[10])
        {
