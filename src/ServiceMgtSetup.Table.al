table 5911 "Service Mgt. Setup"
{
    ...
    // 
    // #RENW16.00.01:R064 15.10.09 DEMSR.KHS
    //   Create Service Item on Purchase
    ...
    fields
    {
        ...
        field(54; "Service Invoice Nos."; Code[10])
        {
            Caption = 'Service Invoice Nos.';
            TableRelation = "No. Series";
        }
        field(55; "Contract Invoice Nos."; Code[10])
        {
            Caption = 'Contract Invoice Nos.';
            TableRelation = "No. Series";
        }
        field(56; "Service Item Nos."; Code[10])
        {
            Caption = 'Service Item Nos.';
            TableRelation = "No. Series";
        }
        field(57; "Service Order Nos."; Code[10])
        {
            Caption = 'Service Order Nos.';
            TableRelation = "No. Series";
        }
        field(58; "Service Contract Nos."; Code[10])
        {
            AccessByPermission = TableData "Service Contract Line" = R;
            Caption = 'Service Contract Nos.';
            TableRelation = "No. Series";
        }
        field(59; "Contract Template Nos."; Code[10])
        {
            AccessByPermission = TableData "Service Contract Line" = R;
            Caption = 'Contract Template Nos.';
            TableRelation = "No. Series";
        }
        field(60; "Troubleshooting Nos."; Code[10])
        {
            Caption = 'Troubleshooting Nos.';
            TableRelation = "No. Series";
        }
        field(61; "Prepaid Posting Document Nos."; Code[10])
        {
            Caption = 'Prepaid Posting Document Nos.';
            TableRelation = "No. Series";
        }
        field(62; "Loaner Nos."; Code[10])
        {
            Caption = 'Loaner Nos.';
            TableRelation = "No. Series";
        }
        ...
        field(66; "Service Quote Nos."; Code[10])
        {
            Caption = 'Service Quote Nos.';
            TableRelation = "No. Series";
        }
        field(68; "Posted Service Invoice Nos."; Code[10])
        {
            Caption = 'Posted Service Invoice Nos.';
            TableRelation = "No. Series";
        }
        field(69; "Posted Serv. Credit Memo Nos."; Code[10])
        {
            Caption = 'Posted Serv. Credit Memo Nos.';
            TableRelation = "No. Series";
        }
        field(70; "Posted Service Shipment Nos."; Code[10])
        {
        ...
        field(85; "Service Credit Memo Nos."; Code[10])
        {
        ...
        field(7601; "Contract Credit Memo Nos."; Code[10])
        {
            AccessByPermission = TableData "Service Contract Line" = R;
            Caption = 'Contract Credit Memo Nos.';
            TableRelation = "No. Series";
        }
        field(5072450; "Work Type Code Internal"; Code[20])
        {
            Caption = 'Work Type Code Internal';
            Description = '#RENW16.00.01:R170';
            TableRelation = "Work Type";
        }
        field(5072650; "Def. Internal Customer No."; Code[20])
        {
            Caption = 'Def. Internal Customer No.';
            Description = '#RENW16.00.01:R064';
            TableRelation = Customer WHERE ("Internal Customer" = CONST (true));
        }
    }
