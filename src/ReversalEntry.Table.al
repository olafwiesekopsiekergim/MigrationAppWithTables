table 179 "Reversal Entry"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Entry Type';
            OptionCaption = ' ,G/L Account,Customer,Vendor,Bank Account,Fixed Asset,Maintenance,VAT';
            OptionMembers = " ","G/L Account",Customer,Vendor,"Bank Account","Fixed Asset",Maintenance,VAT;
        }
        ...
        {
            Caption = 'Source Type';
            OptionCaption = ' ,Customer,Vendor,Bank Account,Fixed Asset,IC Partner';
            OptionMembers = " ",Customer,Vendor,"Bank Account","Fixed Asset","IC Partner";
        }
