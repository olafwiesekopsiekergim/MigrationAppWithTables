table 5138350 "Exp Atlas Export Goods"
{
    Caption = 'Atlas Export Goods';
    ...
    fields
    {
        ...
        {
            Caption = 'AAK No.';
            TableRelation = "Exp Atlas Export Order"."No.";
        }
        ...
        field(24; "Kennnummer der Sendung"; Text[70])
        {
        ...
        field(30; "Verfahren angemeldetes"; Code[2])
        {
            ...
            Description = 'A0124, soll eigentlich I0100';
            TableRelation = "Exp Atlas Table Code".Code;
            //This property is currently not supported
            //TestTableRelation = false;
            ValidateTableRelation = false;
        ...
        field(31; "Verfahren vorangegangenes"; Code[2])
        {
            ...
            Description = 'A0125, soll eigentlich I0100';
            TableRelation = "Exp Atlas Table Code".Code;
            //This property is currently not supported
            //TestTableRelation = false;
            ValidateTableRelation = false;
        ...
        field(32; "Verfahren weiteres"; Code[3])
        {
            ...
            Description = 'A0126, soll eigentlich I0100';
            TableRelation = "Exp Atlas Table Code".Code;
            //This property is currently not supported
            //TestTableRelation = false;
            ValidateTableRelation = false;
        }
        field(33; "Verfahren Ausfuhrerstattung"; Code[3])
        {
            Caption = 'Verfahren Ausfuhrerstattung';
            Description = 'A0147';
        }
        ...
        {
            Caption = 'No. Dangerous Goods (UNDG)';
            Description = 'C0101';
            TableRelation = "Exp Atlas Table Code".Code;
            //This property is currently not supported
            //TestTableRelation = false;
        ...
        field(53; "Adressaten Konstellation"; Code[1])
        {
        ...
        field(70; Masseinheit; Code[3])
        {
            Caption = 'Unit of Measure';
            Description = 'A0143 Vorankündigung';
            TableRelation = "Exp Atlas Table Code".Code;
            //This property is currently not supported
            //TestTableRelation = false;
            ValidateTableRelation = false;
        }
        field(71; Menge; Decimal)
        {
            Caption = 'Quantity';
            DecimalPlaces = 0 : 1;
            Description = 'Menge Vorankündigung';
        }
    ...
    keys
    {
        ...
        key(Key2; "Nummer (KN8)", Ursprungsbundesland, "Verfahren angemeldetes", "Verfahren vorangegangenes")
        {
        }
    }
