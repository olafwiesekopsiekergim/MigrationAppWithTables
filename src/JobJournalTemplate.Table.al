table 209 "Job Journal Template"
{
    ...
    fields
    {
        ...
        field(5292332; "Source Channel"; Option)
        {
            Caption = 'Source Channel';
            Description = ' ,Time Entry,Purchase,Inventory Request,Job Shipment';
            OptionCaption = ' ,Time Entry,Purchase,Inventory Request,Job Shipment';
            OptionMembers = " ","Time Entry",Purchase,"Inventory Request","Job Shipment";
        }
    }
