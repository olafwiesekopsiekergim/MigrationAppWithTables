table 5000096 "Cost Account Analysis View"
{
    ...
    fields
    {
        ...
        field(9; "Cost Account Filter"; Code[250])
        {
        ...
        field(19; "Last Perf. Budget Entry No."; Integer)
        {
            Caption = 'Last Perf. Budget Entry No.';
        }
    }
