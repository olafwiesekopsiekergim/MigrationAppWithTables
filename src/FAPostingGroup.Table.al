table 5606 "FA Posting Group"
{
    ...
    fields
    {
        ...
        field(5483220; "Book Val. Acc. on Scrap (Loss)"; Code[20])
        {
            Caption = 'Book Val. Acc. on Scrap. (Loss)';
            Description = 'FA';
            TableRelation = "G/L Account";
        }
        field(5483221; "Losses Acc. on Scrapping"; Code[20])
        {
            Caption = 'Losses Acc. on  Scrapping';
            Description = 'FA';
            TableRelation = "G/L Account";
        }
    }
