table 5157809 "Pmt. Import Line"
{
    ...
    fields
    {
        ...
        field(66; "Accounted by"; Option)
        {
            ...
            Editable = false;
            OptionCaption = ',BC Code,Accounting Rule,Bank Account,Account No.,Document No.,Sales Order,Purch. Order,Ext. Document No.,Pmt. Transaction,EREF,Reminder,Sales Shipment';
            OptionMembers = ,"BC Code","Accounting Rule","Bank Account","Account No.","Document No.","Sales Order","Purch. Order","Ext. Document No.","Pmt. Transaction",EREF,Reminder,"Sales Shipment";
        }
