table 271 "Bank Account Ledger Entry"
{
    ...
    // --------------------------------------------------------------------------------
    // dyn      21.10.2015  BASE     akq        Implementing dynamo Products (Added Key)
    // ================================================================================
    ...
    fields
    {
        ...
        field(5001900; "Transit Posting"; Boolean)
        {
            Caption = 'Transit Posting';
            Description = 'DYNPMT';
        }
    ...
    keys
    {
        ...
        key(Key8; "Bank Account No.", "Document Type", "Document No.", "External Document No.", "Posting Date")
        {
        }
    }
