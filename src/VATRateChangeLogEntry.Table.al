table 552 "VAT Rate Change Log Entry"
{
    ...
    fields
    {
        ...
        field(30; "Old Gen. Prod. Posting Group"; Code[10])
        {
            Caption = 'Old Gen. Prod. Posting Group';
        }
        field(31; "New Gen. Prod. Posting Group"; Code[10])
        {
            Caption = 'New Gen. Prod. Posting Group';
        }
        field(32; "Old VAT Prod. Posting Group"; Code[10])
        {
            Caption = 'Old VAT Prod. Posting Group';
        }
        field(33; "New VAT Prod. Posting Group"; Code[10])
        {
