table 112 "Sales Invoice Header"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Coupled to Dynamics CRM';
        }
        ...
        {
            CalcFormula = Lookup("E-Bill Invoice Header".Status WHERE("Document Type" = CONST("Sales Invoice"),
        ...
        {
            CalcFormula = Lookup("E-Bill Invoice Header".Comment WHERE("Document Type" = CONST("Sales Invoice"),
                                                                        "Document No." = FIELD("No.")));
