table 5138368 "Exp Atlas Reg Export Order"
{
    Caption = 'Atlas Reg Export Order';
    ...
    fields
    {
        ...
        {
            CalcFormula = Exist ("Exp Atlas Reg Export Container" WHERE ("AAK No." = FIELD ("No.")));
            Caption = 'Container';
            Description = 'kalk';
            Editable = false;
        ...
        {
            CalcFormula = Sum ("Exp Atlas Reg Export Goods".Rohmasse WHERE ("AAK No." = FIELD ("No.")));
        ...
        {
            CalcFormula = Count ("Exp Atlas Reg Export Goods" WHERE ("AAK No." = FIELD ("No.")));
        ...
        {
            CalcFormula = Count ("Exp Atlas Reg Export Seal" WHERE ("AAK No." = FIELD ("No.")));
        ...
        {
            CalcFormula = Sum ("Exp Atlas Reg Export Package".Anzahl WHERE ("AAK No." = FIELD ("No.")));
        ...
        {
            BlankZero = true;
            CalcFormula = Count ("Exp Atlas Reg Export Route" WHERE ("AAK No." = FIELD ("No.")));
        ...
        {
            CalcFormula = Lookup ("Exp Atlas Reg Export Order 2"."Kennnummer der Sendung" WHERE ("No." = FIELD ("No.")));
