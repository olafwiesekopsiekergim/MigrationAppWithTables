table 125 "Purch. Cr. Memo Line"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Exist ("PR - Posted Job Comment Line" WHERE ("Table ID" = CONST (125),
    ...
    keys
    {
        ...
        key(Key5; "Job No.", "Job Line Unique No.")
        {
        }
        key(Key6; "Job Procurement No.")
        {
        }
        key(Key7; "Job No.", "Document No.")
        {
        }
    }
