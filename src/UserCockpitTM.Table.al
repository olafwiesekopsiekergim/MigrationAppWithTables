table 5056430 "UserCockpit/TM"
{
    Caption = 'User Cockpit ';
    Description = 'GrUserCock';
    ...
    fields
    {
        ...
        field(9000; ControlActive; Boolean)
        {
            Caption = 'ControlActive';
        }
        field(9010; NoAccessLinkedPrograms; Boolean)
        {
            Caption = 'NoAccessLinkedPrograms';
        }
