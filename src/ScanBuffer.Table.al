table 5171652 "Scan Buffer"
{
    ...
    fields
    {
        ...
        field(9006; "Universal Code 2"; Code[20])
        {
            Caption = 'Universal Code 2';
        }
        field(9007; "Universal Boolean"; Boolean)
        {
            Caption = 'Universal Boolean';
        }
        field(9008; "Universal Commando"; Text[30])
        {
            Caption = 'Universal Commando';
        }
        field(9010; "Calculate Doclines"; Boolean)
        {
        }
    }
