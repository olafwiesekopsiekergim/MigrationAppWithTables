table 5000230 "Proj. Acc. Analysis View Entry"
{
    Caption = 'Proj. Acc. Analysis View Entry';
    ...
    fields
    {
        ...
        field(3; "Project Account No."; Code[20])
        {
    ...
    keys
    {
        key(Key1; "Analysis View Code", "Business Unit Code", "Project Account No.", "Reference Unit Code", "Dimension 1 Value Code", "Dimension 2 Value Code", "Dimension 3 Value Code", "Dimension 4 Value Code", "Posting Date", "Entry No.")
        {
            Clustered = true;
