table 5992 "Service Invoice Header"
{
    ...
    // 
    // #RENW16.00:10-001  22.04.2009  DEMSR.KHS
    //   Report Selection for Rental Invoice
    // 
    ...
    fields
    {
        ...
        {
            CalcFormula = Lookup ("E-Bill Invoice Header".Status WHERE ("Document Type" = CONST ("Service Invoice"),
                                                                       "Document No." = FIELD ("No.")));
        ...
        {
            CalcFormula = Lookup ("E-Bill Invoice Header".Comment WHERE ("Document Type" = CONST ("Service Invoice"),
                                                                        "Document No." = FIELD ("No.")));
