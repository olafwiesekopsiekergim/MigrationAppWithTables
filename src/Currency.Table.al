table 4 Currency
{
    ...
    fields
    {
        ...
        field(5157802; "ECB Import"; Option)
        {
            Caption = 'ECB Import';
            Description = 'OPP';
            OptionCaption = 'Deactivated,Insert,Update,Insert+Update';
            OptionMembers = Deactivated,Insert,Update,"Insert+Update";
        }
    }
