table 379 "Detailed Cust. Ledg. Entry"
{
    ...
    fields
    {
        ...
        field(5157806; "Unapply this Block"; Boolean)
        {
            Caption = 'Unapply this block';
            Description = 'EA';
        }
        field(5157807; "Single Application unapplied"; Boolean)
        {
            Caption = 'Single Application unapplied';
            Description = 'EA';
        }
    }
