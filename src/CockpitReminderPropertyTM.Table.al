table 5056414 "CockpitReminderProperty/TM"
{
    Caption = 'Cockpit Reminder Property';
    Description = 'GrCockRemProp';
    ...
    keys
    {
        ...
        key(Key2; PropertyType, PropertyNo, PropertyPriority, PropertyDateCheck, "Employee No.", "Line No.")
        {
        }
        key(Key3; PropertyType, PropertyNo, PropertyDateCheck, PropertyPriority, "Employee No.", "Line No.")
        {
        }
        key(Key4; PropertyType, PropertyPriority, PropertyNo, PropertyDateCheck, "Employee No.", "Line No.")
        {
        }
        key(Key5; PropertyType, PropertyPriority, PropertyDateCheck, PropertyNo, "Employee No.", "Line No.")
        {
        }
        key(Key6; PropertyType, PropertyDateCheck, PropertyNo, PropertyPriority, "Employee No.", "Line No.")
        {
        }
        key(Key7; PropertyType, PropertyDateCheck, PropertyPriority, PropertyNo, "Employee No.", "Line No.")
        {
        }
        key(Key8; PropertyNo, PropertyType, PropertyPriority, PropertyDateCheck, "Employee No.", "Line No.")
        {
        }
        key(Key9; PropertyNo, PropertyType, PropertyDateCheck, PropertyPriority, "Employee No.", "Line No.")
        {
        }
        key(Key10; PropertyNo, PropertyPriority, PropertyType, PropertyDateCheck, "Employee No.", "Line No.")
        {
        }
        key(Key11; PropertyNo, PropertyPriority, PropertyDateCheck, PropertyType, "Employee No.", "Line No.")
        {
        }
        key(Key12; PropertyNo, PropertyDateCheck, PropertyType, PropertyPriority, "Employee No.", "Line No.")
        {
        }
        key(Key13; PropertyNo, PropertyDateCheck, PropertyPriority, PropertyType, "Employee No.", "Line No.")
        {
        }
        key(Key14; PropertyPriority, PropertyType, PropertyNo, PropertyDateCheck, "Employee No.", "Line No.")
        {
        }
        key(Key15; PropertyPriority, PropertyType, PropertyDateCheck, PropertyNo, "Employee No.", "Line No.")
        {
        }
        key(Key16; PropertyPriority, PropertyNo, PropertyType, PropertyDateCheck, "Employee No.", "Line No.")
        {
        }
        key(Key17; PropertyPriority, PropertyNo, PropertyDateCheck, PropertyType, "Employee No.", "Line No.")
        {
        }
        key(Key18; PropertyPriority, PropertyDateCheck, PropertyType, PropertyNo, "Employee No.", "Line No.")
        {
        }
        key(Key19; PropertyPriority, PropertyDateCheck, PropertyNo, PropertyType, "Employee No.", "Line No.")
        {
        }
        key(Key20; PropertyDateCheck, PropertyType, PropertyNo, PropertyPriority, "Employee No.", "Line No.")
        {
        }
        key(Key21; PropertyDateCheck, PropertyType, PropertyPriority, PropertyNo, "Employee No.", "Line No.")
        {
        }
        key(Key22; PropertyDateCheck, PropertyNo, PropertyType, PropertyPriority, "Employee No.", "Line No.")
        {
        }
        key(Key23; PropertyDateCheck, PropertyNo, PropertyPriority, PropertyType, "Employee No.", "Line No.")
        {
        }
        key(Key24; PropertyDateCheck, PropertyPriority, PropertyType, PropertyNo, "Employee No.", "Line No.")
        {
        }
        key(Key25; PropertyDateCheck, PropertyPriority, PropertyNo, PropertyType, "Employee No.", "Line No.")
        {
        }
    }
