table 5700 "Stockkeeping Unit"
{
    ...
    // 
    // KANBAN:DMW15.02:28:01 #New Flowfield for KANBAN, Delete KANBAN records, test "Reordering Policy"
    // KANBAN:#DMW16.00.03:A004 09.09.11 DEMSR.SSZ
    ...
    fields
    {
        ...
        field(5012400; "Inventory blocked by QC"; Decimal)
        {
            CalcFormula = Sum ("Item Ledger Entry".Quantity WHERE ("Item No." = FIELD ("Item No."),
                                                                  "Location Code" = FIELD ("Location Code"),
                                                                  "Global Dimension 1 Code" = FIELD ("Global Dimension 1 Filter"),
        ...
        field(5013400; KANBAN; Boolean)
        {
            CalcFormula = Exist (KANBAN WHERE ("Item No." = FIELD ("Item No."),
                                              "Variant Code" = FIELD ("Variant Code"),
                                              "Location Code" = FIELD ("Location Code"),
