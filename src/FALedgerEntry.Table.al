table 5601 "FA Ledger Entry"
{
    ...
    //                 - New Fields added
    //                 - Field "Quantity" changed
    //                 - Field "Quantity" added as SumIndexField to all Keys
    // -----------------------------------------------------
    ...
    fields
    {
        ...
        field(27; "FA Posting Group"; Code[10])
        {
        ...
        field(68; "Tax Group Code"; Code[10])
        {
        ...
        field(70; "VAT Bus. Posting Group"; Code[10])
        {
            Caption = 'VAT Bus. Posting Group';
            TableRelation = "VAT Business Posting Group";
        }
        field(71; "VAT Prod. Posting Group"; Code[10])
        {
        ...
        field(5483220; Scrapped; Boolean)
        {
            Caption = 'Scrapped';
            Description = 'FA';
        }
        field(5483221; "Payment Disc. Possible Gross"; Decimal)
        {
            Caption = 'Payment Discount Possible Gross Amount';
            Description = 'FA';
        }
        field(5483222; "Payment Discount Possible %"; Decimal)
        {
            Caption = 'Payment Discount Possible %';
            Description = 'FA';
        }
        field(5483223; "Payment Disc. Possible Net"; Decimal)
        {
            Caption = 'Payment Discount Possible Net Amount';
            Description = 'FA';
        }
        field(5483224; "Payment Disc. Realized Net"; Decimal)
        {
            Caption = 'Payment Discount Realized Net Amount';
            Description = 'FA';
        }
        field(5483225; "Orig FA Entry No."; Integer)
        {
            Caption = 'Orig FA Entry No.';
            Description = 'FA';
        }
    }
