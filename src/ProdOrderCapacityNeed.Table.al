table 5410 "Prod. Order Capacity Need"
{
    ...
    //   New Key <"Requested Only", Type, "No.", Date, Status, "Starting Time"> added (Form "Plan Table Work Center")
    //   New Key <Type, "No.", Date, "Time Type"> (Form 5012752 Work Center Setup - Bar Chart)
    // 
    // :PMW13.71:1:1
    //   New field for tool management
    // 
    // :PMW16.00:160:1
    //   Changed keys for detail planning  --> #PXW16.00:107
    ...
    fields
    {
        ...
        field(5012400; "PO Rout.Tool Line"; Integer)
        {
            Caption = 'PO Rout.Tool Line';
    ...
    keys
    {
        ...
        key(Key13; "Requested Only", Type, "No.", Date, Status, "Starting Time")
        {
        }
        key(Key14; Type, "No.", Date, "Time Type")
        {
            SumIndexFields = "Allocated Time";
        }
    }
