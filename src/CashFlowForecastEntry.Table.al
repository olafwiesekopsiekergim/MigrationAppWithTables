table 847 "Cash Flow Forecast Entry"
{
    ...
    fields
    {
        ...
        field(14; "Source Type"; Option)
        {
            Caption = 'Source Type';
            Editable = false;
            OptionCaption = ' ,Receivables,Payables,Liquid Funds,Cash Flow Manual Expense,Cash Flow Manual Revenue,Sales Order,Purchase Order,Fixed Assets Budget,Fixed Assets Disposal,Service Orders,G/L Budget';
            OptionMembers = " ",Receivables,Payables,"Liquid Funds","Cash Flow Manual Expense","Cash Flow Manual Revenue","Sales Order","Purchase Order","Fixed Assets Budget","Fixed Assets Disposal","Service Orders","G/L Budget";
        }
        ...
        field(33; "Source No."; Code[20])
        {
            ...
            ELSE
            IF ("Source Type" = CONST (Receivables)) Customer
            ELSE
            IF ("Source Type" = CONST (Payables)) Vendor
            ELSE
