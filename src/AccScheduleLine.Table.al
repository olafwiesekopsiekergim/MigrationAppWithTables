table 85 "Acc. Schedule Line"
{
    ...
    fields
    {
        ...
        field(5157882; "Balance Position"; Option)
        {
            Caption = 'Balance Position';
            Description = 'TAX';
            OptionCaption = ' ,Assets Each,Liabilities Each,Assets Group,Liabilities Group';
            OptionMembers = " ","Assets Each","Liabilities Each","Assets Group","Liabilities Group";
        }
        field(5157883; "Separate Recv. and Pay."; Boolean)
        {
            Caption = 'Separate Receivables and Payables as Assets and Liabilities';
            Description = 'TAX';
        }
        field(5157884; "Detailed Export"; Boolean)
        {
            Caption = 'Detailed Export';
            Description = 'TAX';
        }
        field(5157885; Structure; Code[10])
        {
            Caption = 'Structure';
            Description = 'TAX';
        }
        field(5157886; "Ext. Totaling Type"; Option)
        {
            Caption = 'Ext. Totaling Type';
            Description = 'TAX';
            OptionCaption = ' ,G/L Account Group 1,G/L Account Group 2,G/L Account Group 3,G/L Account Group 4';
            OptionMembers = " ","G/L Account Group 1","G/L Account Group 2","G/L Account Group 3","G/L Account Group 4";
        }
        field(5157887; "Ext. Totaling"; Text[250])
        {
            Caption = 'Ext. Totaling';
            Description = 'TAX';
            TableRelation = IF ("Ext. Totaling Type" = CONST ("G/L Account Group 1")) "G/L Account Group"
            ELSE
            IF ("Ext. Totaling Type" = CONST ("G/L Account Group 2")) "G/L Account Group"
            ELSE
            IF ("Ext. Totaling Type" = CONST ("G/L Account Group 3")) "G/L Account Group"
            ELSE
            IF ("Ext. Totaling Type" = CONST ("G/L Account Group 4")) "G/L Account Group";
            //This property is currently not supported
            //TestTableRelation = false;
            ValidateTableRelation = false;
        }
