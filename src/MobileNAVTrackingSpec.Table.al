table 42012835 "MobileNAV Tracking Spec."
{
    Caption = 'MobileNAV Tracking Spec.';
    ...
    fields
    {
        ...
        field(42012823; "User ID"; Code[50])
        {
        }
        field(42012824; CurrentSignFactor; Integer)
        {
        }
        field(42012825; MainQtyBase; Decimal)
        {
        }
        field(42012826; MainQtyToHandle; Decimal)
        {
        }
        field(42012827; MainQtyToInvoice; Decimal)
        {
        }
        field(42012828; HideQtyToHandle; Boolean)
        {
        }
        field(42012829; HideQtyToInvoice; Boolean)
        {
        }
        field(42012830; ReadOnlySerialNo; Boolean)
        {
        }
        field(42012831; ReadOnlyLotNo; Boolean)
        {
        }
        field(42012832; ReadOnlyExpirationDate; Boolean)
        {
        }
        field(42012833; ReadOnlyQuantity; Boolean)
        {
        }
        field(42012834; SerialNoLookupAvailable; Boolean)
        {
        }
        field(42012835; LotNoLookupAvailable; Boolean)
        {
        }
        field(42012836; SecondSourceTable; Decimal)
        {
        }
        field(42012837; Direction; Option)
        {
            OptionCaption = 'Outbound,Inbound';
            OptionMembers = Outbound,Inbound;
        }
        field(42012838; HideNewSerialNo; Boolean)
        {
        }
        field(42012839; HideNewLotNo; Boolean)
        {
        }
        field(42012840; HideNewExpirationDate; Boolean)
        {
        }
    }
