table 5000234 "PA Analysis View Budget Entry"
{
    Caption = 'PA Analysis View Budget Entry';
    ...
    fields
    {
        ...
        field(4; "Project Account No."; Code[20])
        {
    ...
    keys
    {
        key(Key1; "Analysis View Code", "Budget Name", "Business Unit Code", "Project Account No.", "Reference Unit Code", "Dimension 1 Value Code", "Dimension 2 Value Code", "Dimension 3 Value Code", "Dimension 4 Value Code", "Posting Date", "Entry No.")
        {
            Clustered = true;
