table 5292374 "PR - Job Shipment Header"
{
    ...
    fields
    {
        ...
        field(7205; "Ship-to City"; Text[30])
        {
        ...
        field(5292342; "Job Comment"; Boolean)
        {
            CalcFormula = Exist ("PR - Job Comment Line" WHERE ("Table ID" = CONST (5292374),
                                                               Code1 = FIELD ("No.")));
            Caption = 'Job Comment';
