table 5000076 "Allocation Line"
{
    ...
    fields
    {
        ...
        field(50; "Ignore Iss.Dim. Codes on Ref.U"; Boolean)
        {
            Caption = 'Ignore Issuing Dimension Codes on Reference Units';
        }
    ...
    keys
    {
        key(Key1; "Allocation Header Code", "Line No.")
        {
            Clustered = true;
        }
    }
