table 1222 "Data Exch. Def"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Type';
            OptionCaption = 'Bank Statement Import,Payment Export,Payroll Import,Generic Import,Positive Pay Export';
            OptionMembers = "Bank Statement Import","Payment Export","Payroll Import","Generic Import","Positive Pay Export";
        }
        ...
        field(10; "Column Separator"; Option)
        {
            ...
            InitValue = Comma;
            OptionCaption = ',Tab,Semicolon,Comma,Space';
            OptionMembers = ,Tab,Semicolon,Comma,Space;
        }
