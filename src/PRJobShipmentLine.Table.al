table 5292375 "PR - Job Shipment Line"
{
    // cc|mobile solution (CCMS)
    //   CCMS01  16.01.15  DEDRS.RKRA
    //     New fields (see description column)

    Caption = 'Job Shipment Line';
    PasteIsValid = false;
    ...
    fields
    {
        ...
        {
            CalcFormula = Exist ("PR - Job Comment Line" WHERE ("Table ID" = CONST (5292375),
                                                               Code1 = FIELD ("Header No."),
                                                               Int1 = FIELD ("Line No.")));
            Caption = 'Job Comment';
