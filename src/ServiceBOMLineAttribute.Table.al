table 5013779 "Service BOM Line Attribute"
{
    ...
    // #DMW16.00.02.03:A0011 30.03.11 DEMSR.SSZ
    //   #Update measurement fields in Service BOM Line
    // #DMW17.10.00.03:T100 31.07.14 DEMSR.IST - Rebranding
    // #DMW17.10.01:T102 26.09.14 DEMSR.SSZ
    //   #Changed length of variable codes: 10 -> 30

    Caption = 'Service BOM Line Attribute';
    ...
    keys
    {
        key(Key1; "Document No.", Active, "Entry No.", "Line No.")
        {
            Clustered = true;
        }
    }
