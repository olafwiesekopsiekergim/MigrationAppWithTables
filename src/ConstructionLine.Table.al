table 5013631 "Construction Line"
{
    ...
    // :DMW15.01:25:01 #All line in a Construction Inquiry are not order tracking relevant
    ...
    // :DMW15.01.00.01:6:01 #PrimaryKey Field -> NotBlank, deleted TableRelation in Field 85000 and changed LookUp, corrected double Var.
    // 
    // :DMW15.01.00.02:6:01 #BOMCapNeed must be deleted, too
    // :DMW15.02:6:01 #Wait and Move Time field must be copied from cards
    ...
    //   #New parameter needed in function SetLevel; Transfered function "SetLevel" from form into table
    //   #New functions ClearNumbers, OpenNextLevel; renamed "GetSalesHeaderALine" to "GetConstHeader", deleted unneeded calls
    ...
    //   #New field 1000; not allowed to change rec, when a purchase order for g/l account was created. Corrected Fieldname
    // #DMW16.00.03.02:A021 06.03.12 DEMSR.SSZ
    //   #Function TestStatusOpen is not longer local because its used in another codeunit
    // #DMW16.00.03:02:A023 21.03.12 DEMSR.SSZ
    //   #Correct grammatical issues
    // #DMW16.00.03.03:A001 22.06.12 DEMSR.SSZ
    //   #Only fill in a "Belongs to Entry No." if this parent line also exists. Possible error when deleting and reinserting lines
    // #DMW17.00:A001 04.04.12 DEMSR.SSZ
    //   #Changes because of NAV 7
    //   #Management of Dimensions
    //   #File Dialog, User ID
    //   #New functions for inventory profile offsetting
    //   #Starting of Order Promise
    //   #Description 2: Text 30 -> 50
    //   #When open file first check if field Drawing is not empty
    ...
    //   #Replaced wrong ERROR-Message
    // #DMW17.00.00.01:A0019 21.08.13 DEMSR.SSZ
    //   #Analyze CTO Setup if lines for planing exist or not
    // #DMW17.00.00.01:A0022 23.08.13 DEMSR.SSZ
    //   #Save also the Dimension Set ID in function InitLine
    //   #OnInsert get dimensions from sales line
    ...
    // #DMW18.00.00.03:T501 10.04.15 DEMSR.SSZ
    //   #Changed function OrderPromising to be more like NAV standard
    ...
    //   #Parallel Routings: New fields: 1100, 1110, 1120, 1130
    //   #Deleted global variable ConstLine
    ...
    fields
    {
        field(20; "Document No."; Code[20])
        {
            ...
            Editable = false;
            NotBlank = true;
            TableRelation = "Construction Header"."No.";
        }
        ...
        {
            CalcFormula = Exist("Construction Line" WHERE("Document No." = FIELD("Document No."),
        ...
        field(2000; "Document BOM No."; Code[20])
        {
            Caption = 'Document BOM No.';
            Description = '#DMW18.00.01:T111';
            Editable = false;
        }
        field(2001; "Document BOM Entry No."; Integer)
        {
            Caption = 'Document BOM Entry No.';
            Description = '#DMW18.00.01:T111';
            Editable = false;
        }
        ...
        {
            CalcFormula = - Sum("Reservation Entry".Quantity WHERE("Source Type" = CONST(5013631),
        ...
        {
            CalcFormula = - Sum("Reservation Entry"."Quantity (Base)" WHERE("Source Type" = CONST(5013631),
                                                                            "Source ID" = FIELD("Document No."),
                                                                            "Source Ref. No." = FIELD("Entry No."),
                                                                            "Reservation Status" = CONST(Reservation)));
        ...
        field(85620; "Last User ID Modified"; Code[50])
        {
    ...
    keys
    {
        ...
        key(Key8; "No.", Type, "Shortcut Dimension 1 Code", "Shortcut Dimension 2 Code", "Location Code", "Variant Code", "Shipment Date", Status, "Order Tracking Relevance", "Information Line")
        {
            SumIndexFields = "Exp. Quantity (Base)";
        }
        key(Key9; "Separate Prod. Order", Type, Status, Level)
        {
        }
        key(Key10; "No.")
        {
        }
        key(Key11; "Document No.", "Entry No. Representation saved")
        {
        }
    }
