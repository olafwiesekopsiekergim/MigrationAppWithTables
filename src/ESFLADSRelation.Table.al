table 14123810 "ES FLADS Relation"
{
    Caption = 'Field Level and Data Security Relation';
    ...
    fields
    {
        ...
        {
            CalcFormula = Lookup (AllObjWithCaption."Object Caption" WHERE ("Object Type" = FIELD ("Relation Object Type"),
        ...
        field(24; "Code Implemented"; Boolean)
        {
            Caption = 'Code Implemented';
        }
        field(25; "Security Filter Object"; Boolean)
        {
            CalcFormula = Exist ("ES Object Property" WHERE ("Object Type" = FIELD ("Object Type"),
                                                            "Object ID" = FIELD ("Object ID"),
        ...
        field(26; "Security Filter Relation Obj."; Boolean)
        {
            CalcFormula = Exist ("ES Object Property" WHERE ("Object Type" = FIELD ("Object Type"),
                                                            "Object ID" = FIELD ("Object ID"),
                                                            "Security Filter Table" = CONST (true)));
        ...
        field(27; "Limited User Included Object"; Boolean)
        {
            CalcFormula = Exist ("ES Object Property" WHERE ("Object Type" = FIELD ("Object Type"),
                                                            "Object ID" = FIELD ("Object ID"),
        ...
        field(28; "Limited User Incl. Rel. Object"; Boolean)
        {
            CalcFormula = Exist ("ES Object Property" WHERE ("Object Type" = FIELD ("Relation Object Type"),
                                                            "Object ID" = FIELD ("Relation Object ID"),
                                                            "Limited User Table Access" = CONST (Included)));
    ...
    fieldgroups
    {
        fieldgroup(DropDown; "Object Type", "Object ID", "Object Caption", "Relation Object ID", "Entry No.")
        {
        }
    }
}
