table 5138375 "Exp Atlas Reg Export Order 2"
{
    Caption = 'Atlas Reg Export Order 2';
    ...
    fields
    {
        ...
        {
            Caption = 'Shipment Identification Number';
        }
        field(11; Ausfuhrland; Code[10])
        {
            Caption = 'Export Country Code';
            Description = 'C0010';
        }
        ...
        {
            Caption = 'Depatch Id. of the means of transport';
        }
        ...
        field(1102; "Datum verzoegerter Ausgang"; Date)
        {
            Caption = 'Date of delayed Dispatch';
        }
