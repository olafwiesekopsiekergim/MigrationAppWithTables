table 42014829 "Servotion Arch Serv. Header"
{
    Caption = 'Archive Service Header';
    ...
    fields
    {
        ...
        {
            CalcFormula = Min ("Servotion Arch Serv. Line"."Completely Shipped" WHERE ("Document Type" = FIELD ("Document Type"),
        ...
        {
            CalcFormula = Count ("Servotion Arch Serv. Item Line" WHERE ("Document Type" = FIELD ("Document Type"),
                                                                        "Document No." = FIELD ("No."),
        ...
        {
            CalcFormula = Exist ("Servotion Arch Serv. O. Alloc." WHERE (Status = CONST ("Reallocation Needed"),
                                                                        "Resource No." = FIELD ("Resource Filter"),
        ...
        {
            CalcFormula = Count ("Servotion Arch Serv. Item Line" WHERE ("Document No." = FIELD ("No."),
                                                                        "Document Type" = FIELD ("Document Type")));
        ...
        field(42014850; "Archived By"; Code[50])
        {
            Caption = 'Archived By';
        }
