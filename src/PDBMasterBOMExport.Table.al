table 5013879 "PDB Master BOM Export"
{
    // Copyright (Exclusive Rights): COSMO CONSULT Licensing GmbH, Sarnen, Switzerland
    // 
    // :DMW15.01.00.01:6:01 #PrimaryKey Field -> NotBlank, NotBlank = No in field ID
    // #DMW17.00:A001 31.05.12 DEMSR.SSZ
    //   #Field: ID Code 10 -> 20
    //   #Changes because of NAV 7, "User ID"
    // #DMW17.10.00.03:T100 31.07.14 DEMSR.IST - Rebranding

    Caption = 'PDB Master BOM Export';
    DataCaptionFields = ID, Version, "Item No.";
    ...
    keys
    {
        key(Key1; "Entry No.", "Item No.", "Variant Code", "Entry No. PDB")
        {
            Clustered = true;
        }
    }
