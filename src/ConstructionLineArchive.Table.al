table 5013634 "Construction Line Archive"
{
    ...
    // :DMW15.01.00.01:6:01 #corrected some Test- and ValidateTableRelations
    ...
    //  #Corrected TableRelation in field "Document No."
    ...
    Caption = 'Construction Line Archive';
    ...
    fields
    {
        ...
        {
            CalcFormula = Exist ("Construction Line Archive" WHERE ("Document No." = FIELD ("Document No."),
    ...
    keys
    {
        key(Key1; "Document No.", Version, "Entry No.")
        {
            Clustered = true;
        }
    }
