table 99000765 "Manufacturing Setup"
{
    ...
    //   New field "Send Note on Prod. Order Delay" added
    ...
    fields
    {
        ...
        field(20; "Simulated Order Nos."; Code[10])
        {
            Caption = 'Simulated Order Nos.';
            TableRelation = "No. Series";
        }
        field(21; "Planned Order Nos."; Code[10])
        {
            Caption = 'Planned Order Nos.';
            TableRelation = "No. Series";
        }
        field(22; "Firm Planned Order Nos."; Code[10])
        {
            Caption = 'Firm Planned Order Nos.';
            TableRelation = "No. Series";
        }
        field(23; "Released Order Nos."; Code[10])
        {
            Caption = 'Released Order Nos.';
            TableRelation = "No. Series";
        }
        field(29; "Work Center Nos."; Code[10])
        {
            AccessByPermission = TableData "Machine Center" = R;
            Caption = 'Work Center Nos.';
            TableRelation = "No. Series";
        }
        field(30; "Machine Center Nos."; Code[10])
        {
            AccessByPermission = TableData "Machine Center" = R;
        ...
        {
            Caption = 'Current Production Forecast';
        ...
        field(41; "Default Dampener Quantity"; Decimal)
        {
            Caption = 'Default Dampener Quantity';
            DecimalPlaces = 1 : 1;
            MinValue = 0;
        }
        ...
        field(5012400; "Send Note on Prod. Order Delay"; Boolean)
        {
            Caption = 'Send Note on Prod. Order Delay';
