table 5768 "Whse. Cross-Dock Opportunity"
{
    ...
    fields
    {
        ...
        field(16; "To Source Document"; Option)
        {
            ...
            OptionCaption = ',Sales Order,,,,,,,Purchase Return Order,,Outbound Transfer,Prod. Order Comp.,,,,,,,,,Assembly Consumption,Assembly Order';
            OptionMembers = ,"Sales Order",,,,,,,"Purchase Return Order",,"Outbound Transfer","Prod. Order Comp.",,,,,,,,,"Assembly Consumption","Assembly Order";
        }
