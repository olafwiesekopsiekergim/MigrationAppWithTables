table 42014831 "Servotion Arch Serv. Line"
{
    Caption = 'Archive Service Line';
    PasteIsValid = false;
    ...
    fields
    {
        ...
        field(42014892; "Source Service Ledger Entry No"; Integer)
        {
            Caption = 'Source Service Ledger Entry No.';
        }
    }
