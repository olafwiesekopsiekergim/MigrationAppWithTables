...
{
    // :DMW14.00:1:01 #Erweiterungen für Belegstückliste und Konstruktion
    ...
    fields
    {
        field(1; "Demand Type"; Option)
        {
            Caption = 'Demand Type';
            Editable = false;
            OptionCaption = ' ,Production,Sales,Service,Job,Assembly,,Doc-BOM,Construction';
            OptionMembers = " ",Production,Sales,Service,Job,Assembly,,"Doc-BOM",Construction;
        }
