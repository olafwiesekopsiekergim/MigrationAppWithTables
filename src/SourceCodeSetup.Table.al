table 242 "Source Code Setup"
{
    ...
    fields
    {
        ...
        field(5000000; "Cost Account Journal"; Code[10])
        {
            Caption = 'Cost Account Journal';
            TableRelation = "Source Code";
        }
        field(5000001; "Performance Journal"; Code[10])
        {
            Caption = 'Performance Journal';
            TableRelation = "Source Code";
        }
        field(5000002; "Distribution Cost To Proj.Acc."; Code[10])
        {
            Caption = 'Distribution Cost To Proj.Acc.';
            TableRelation = "Source Code";
        }
        field(5000003; "Allocation Journal"; Code[10])
        {
            Caption = 'Allocation Journal';
            TableRelation = "Source Code";
        }
        field(5000004; "Transfer G/L to Cost Account"; Code[10])
        {
            Caption = 'Transfer G/L to Cost Account';
            TableRelation = "Source Code";
        }
        field(5000005; "Compress Cost Account Ledger"; Code[10])
        {
            Caption = 'Compress Cost Account Ledger';
            TableRelation = "Source Code";
        }
        field(5000006; "Trans. Perfo. to Cost Account"; Code[10])
        {
            Caption = 'Trans. Perfo. to Cost Account';
            TableRelation = "Source Code";
        }
        field(5000007; "Transfer CABudget to Actual"; Code[10])
        {
            Caption = 'Transfer Cost Account Budget to Actual';
            TableRelation = "Source Code";
        }
        field(5000008; "Transfer PerfBudget to Actual"; Code[10])
        {
            Caption = 'Transfer Performance Budget to Actual';
            TableRelation = "Source Code";
        }
        field(5000200; "Project Account Journal"; Code[10])
        {
            Caption = 'Project Account Journal';
            TableRelation = "Source Code";
        }
        field(5000201; "Compress Proj. Account Ledger"; Code[10])
        {
            Caption = 'Compress Proj. Account Ledger';
            TableRelation = "Source Code";
        }
        field(5000203; "Overhead Distribution"; Code[10])
        {
            Caption = 'Overhead Distribution';
            TableRelation = "Source Code";
        }
        field(5000204; "Performance Distribution"; Code[10])
        {
            Caption = 'Performance Distribution';
            TableRelation = "Source Code";
        }
        field(5000205; "Reference Unit Journal"; Code[10])
        {
            Caption = 'Reference Unit Journal';
            TableRelation = "Source Code";
        }
        field(5000206; "Overhead Journal"; Code[10])
        {
            Caption = 'Overhead Journal';
            TableRelation = "Source Code";
        }
        field(5000207; "Transfer G/L to Proj. Account"; Code[10])
        {
            Caption = 'Transfer G/L to Proj. Account';
            TableRelation = "Source Code";
        }
        field(5000208; "Trans. Perfo. to Proj. Account"; Code[10])
        {
            Caption = 'Trans. Perfo. to Proj. Account';
            TableRelation = "Source Code";
        }
        field(5000209; "Transfer PABudget to Actual"; Code[10])
        {
            Caption = 'Transfer Project Account Budget to Actual';
            TableRelation = "Source Code";
        }
        field(5000210; "Trans. Sale Ord. to Proj. Acc."; Code[10])
        {
            Caption = 'Trans. Sale Ord. to Proj. Acc.';
            TableRelation = "Source Code";
        }
        field(5001901; "Corrected Paymentfile"; Code[10])
        {
            Caption = 'Corrected Paymentfile';
            Description = 'DYNPMT';
            TableRelation = "Source Code";
        }
        field(5001902; "Compress Paym. Ledger Entry"; Code[10])
        {
            Caption = 'Compress Paym. Ledger Entry';
            Description = 'DYNPMT';
            TableRelation = "Source Code";
        }
        field(5001903; "Foreign Payment Journal"; Code[10])
        {
            Caption = 'Foreign Payment Journal';
            Description = 'DYNPMT';
            TableRelation = "Source Code";
        }
        field(5001904; "Bank Acc. Reconciliation"; Code[10])
        {
            Caption = 'Bank Acc. Reconciliation';
            Description = 'DYNPMT';
            TableRelation = "Source Code";
        }
        field(5001905; "Customer Payment Journal"; Code[10])
        {
            Caption = 'Customer Payment Journal';
            Description = 'DYNPMT';
            TableRelation = "Source Code";
        }
        field(5001906; "Vendor Payment Journal"; Code[10])
        {
            Caption = 'Vendor Payment Journal';
            Description = 'DYNPMT';
            TableRelation = "Source Code";
        }
        ...
        field(5072650; "Rental Management"; Code[10])
        {
            Caption = 'Rental Management';
            TableRelation = "Source Code";
        }
        field(5308660; "FDC Input Journal"; Code[10])
        {
            Caption = 'FDC Input Journal';
            Description = 'CCFDC';
            TableRelation = "Source Code";
        }
        field(5308670; "FDC Journal"; Code[10])
        {
            Caption = 'FDC Journal';
            Description = 'CCFDC';
            TableRelation = "Source Code";
        }
        field(5308680; "FDC STDC Journal"; Code[10])
        {
            Caption = 'FDC STDC Journal';
            Description = 'CCFDC';
            TableRelation = "Source Code";
        }
        field(5370525; "G/L Entry Application"; Code[10])
        {
